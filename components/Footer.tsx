...
const primaryGradient = "from-[#ff003a] to-black-500";

const Footer = () => {
  return (
    <footer className="bg-black/60 backdrop-blur-2xl border-t border-[#ff003a]/30 py-8 sm:py-12 px-4 sm:px-6 lg:px-8 shadow-2xl shadow-[#ff003a]/10">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-row space-x-4">
            <a
              href="#"
              className="text-[#ff003a] hover:text-white transition-all duration-300 drop-shadow-lg text-sm flex items-center"
              title="Whitepaper"
            >
